...
import imagePublicRoutes from './public/imagePublic.route';
import imagePrivateRoutes from './private/imagePrivate.route';
...
publicRouter.use('/api/v1/image', imagePublicRoutes);
...
privateRouter.use('/api/v1/image', imagePrivateRoutes);
