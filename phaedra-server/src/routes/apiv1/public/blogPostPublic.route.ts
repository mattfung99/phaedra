...
import { validateDraft } from 'middlewares/draftValidation.mw';
...
router.get('/:id', validateParamId('id', TABLE_BLOG_POST, blogPostNegativeOrNanInputError, blogPostDNEError), validateDraft, controller.getBlogPostById);
